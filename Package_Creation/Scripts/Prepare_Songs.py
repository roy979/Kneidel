...
print("Fetching Spotify Credentials From The Server...", end="", flush=True)
try:
    ...
    print(f"\nFailed to get credentials from external API: {e}")
...
echo Starting Demucs separation for: "{song_name}"
cd /d "%~dp0"

"C:\\Users\\RoyWaisbord\\anaconda3\\python.exe" -m demucs "{song_path}" -n htdemucs_6s --shifts 10 --overlap 0.4 --flac -d cpu -o "{song_dir}"
if errorlevel 1 (
